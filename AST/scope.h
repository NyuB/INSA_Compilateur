...
int scp_contains(scope * scp, char * name);//Retourne l'addresse de la variable si contenue dans le scope, NOT_FOUND sinon

void scp_add(scope * scp, char * name);//Ajoute ce nom de variable au scope (TODO gérer l'adresse)
